...
public class JugadorAnimado2 extends ObjetoJuego{
	...
	public JugadorAnimado2(int x, int y, String nombreImagen, int velocidad, int vidas, String animacionActual) {
	...
	public void inicializarAnimaciones() {
		Rectangle coordenadasCorrer[] = {
				new Rectangle(70, 165, 53, 111),
				new Rectangle(155, 165, 46, 111),
				new Rectangle(221, 165, 68, 111),
				new Rectangle(315, 161, 47, 116),
				new Rectangle(380, 165, 79, 111)
		};
		...
		Rectangle coordenadasDescanso [] = {
				new Rectangle(70, 35, 60, 120),
				new Rectangle(146, 35, 65, 121),
				new Rectangle(225, 35, 65, 120)
		};
	...
	public void verificarColisionesItem(Items item) {
		if(Juego.q &this.obtenerRectangulo().getBoundsInLocal().intersects(item.obtenerRectangulo().getBoundsInLocal())) {
