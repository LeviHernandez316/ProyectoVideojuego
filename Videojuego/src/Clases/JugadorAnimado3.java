...
public class JugadorAnimado3 extends ObjetoJuego{
	private int vidas;
	...
	public JugadorAnimado3(int x, int y, String nombreImagen, int velocidad, int vidas, String animacionActual) {
	...
	public void inicializarAnimaciones() {
		...
		Rectangle coordenadasDescanso [] = {
				new Rectangle(10, 20, 100, 120),
				new Rectangle(120, 20, 91, 122),
				new Rectangle(230, 20, 81, 122)
		};
	...
	public void verificarColisionesItem(Items item) {
		if(Juego.u &this.obtenerRectangulo().getBoundsInLocal().intersects(item.obtenerRectangulo().getBoundsInLocal())) {
